    ...
    <tr>
        ...
        <tr>
            <td colspan="12" align="left"><br>
                <h3 style="color: white;">Productos/Servicios</h3>
            </td>
        </tr>
    </table>
    <table width="100%">
        ...
        <tr>
            ...
            <td>
                <section class="l">
                    <div class="contenedor">
                        <figure>
                            <img src="image/J10F8-23.png">
                            <div class="capa">
                                <h3>Land Cruiser Hardtop</h3>
                                <p>Modelo J10F8-23 Diesel,Turbo Intercooler DOHC,32 Válvulas,COMMON RAIL, 430/1200- 3200 NM/rpm
<br>Q529,990 </p>
                            </div>
                        </figure>
                    </div>
